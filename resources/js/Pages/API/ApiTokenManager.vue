  ...
  <div>
    ...
    <jet-form-section @submitted="createApiToken">
      ...
      <template #form>
        ...
        <div class="col-span-6 sm:col-span-4 relative label-floating">
          <jet-input id="name" type="text" class="block w-full" v-model="createApiTokenForm.name" autofocus />
          <jet-label for="name" value="Name" />
          <jet-input-error :message="createApiTokenForm.error('name')" class="mt-1" />
        </div>
      ...
      <template #actions>
        ...
        <jet-button :class="{ 'opacity-50 hover:opacity-50': createApiTokenForm.processing }" :disabled="createApiTokenForm.processing">
          Create
        </jet-button>
      </template>
    </jet-form-section>
    ...
    <jet-dialog-modal :show="managingPermissionsFor" @close="managingPermissionsFor = null">
      ...
      <template #footer>
        ...
        <jet-button class="ml-2" @click.native="updateApiToken" :class="{ 'opacity-50 hover:opacity-50': updateApiTokenForm.processing }" :disabled="updateApiTokenForm.processing">
          Save
        </jet-button>
      </template>
    </jet-dialog-modal>
    ...
    <jet-confirmation-modal :show="apiTokenBeingDeleted" @close="apiTokenBeingDeleted = null">
      ...
      <template #footer>
        ...
        <jet-danger-button class="ml-2" @click.native="deleteApiToken" :class="{ 'opacity-50 hover:opacity-50': deleteApiTokenForm.processing }" :disabled="deleteApiTokenForm.processing">
          Delete
        </jet-danger-button>
      </template>
